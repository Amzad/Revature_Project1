...
namespace BusinessLayer
{
    public class CustomerBL
    {
        ...
        public String Create(String firstName, String lastName, String custEmail, String phoneNumber)
        {
            try
            {
                CustomerDAL custDal = new CustomerDAL();
                String newCust = custDal.Create(new Customer() { FirstName = firstName, LastName = lastName, Email = custEmail, PhoneNumber = phoneNumber });
                //Customer newCust = custDal.Create();
       ...
       /* public Account DeleteAccount(int custID, int accID)
        {
            new CustomerContext().deleteAccount(custID, accID);
